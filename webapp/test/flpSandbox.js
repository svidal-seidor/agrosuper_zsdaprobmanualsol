		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aprobación Manual de Solicitudes",
									"targetURL": "#wfprecioszsdaprobmanualsol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"wfprecioszsdaprobmanualsol-display": {
								"semanticObject": "wfprecioszsdaprobmanualsol",
								"action": "display",
								"description": "Aprobación Manual Solicitudes",
								"title": "Aprobación Manual de Solicitudes",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=wfprecios.zsdaprobmanualsol",
									"url": sap.ui.require.toUrl("wfprecios/zsdaprobmanualsol")
								}
							}
						}
					}
